...
module.exports = class User {
  ...
  static async createProfile({ username, pronoun, experience }, id) {
    const { rows } = await pool.query(
      'UPDATE users SET username=$1, pronoun=$2, experience=$3 WHERE users.user_id=$4 RETURNING *',
      [username, pronoun, experience, id]
    );
